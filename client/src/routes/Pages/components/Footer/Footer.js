  ...
  <footer>
    <div style="font-weight:100">
        ...
        <span style="font-size:smaller">
          A free share now adaptation of <a class="sec-clr" href="//blaze.vercel.com" target="_blank">Blaze</a> - <a class="sec-clr" href="//github.com/blenderskool/blaze/blob/master/LICENSE" target="_blank">MIT License</a>
        </span>
    </div>
    <script>
